        ...
        <Layout>
            ...
            <div className="section" style={{minHeight: "700px"}}>
                 <section>
                    ...
                    <p style={{paddingTop: "0.75em"}}>De acuerdo con los derechos que le confiere el la normativa vigente en protección de datos podrá ejercer los derechos de acceso, rectificación, limitación de tratamiento, supresión, portabilidad y oposición al tratamiento de sus datos de carácter personal así como del consentimiento prestado para el tratamiento de los mismos, dirigiendo su petición a la dirección postal indicada más arriba o al correo electrónico Asesoria.runakuna@gmail.com.</p>
                    <p style={{paddingTop: "0.75em"}}>Podrá dirigirse a la Autoridad de Control competente para presentar la reclamación que considere oportuna.</p>
                    <p style={{paddingTop: "0.75em"}}>Con el envío del formulario de recogida de datos usted acepta la política de privacidad de ASESORÍA JURÍDICA RUNAKUNA.</p>
                </section>
            </div>
            </div>
        </Layout>
